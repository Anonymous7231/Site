...
//					String SQL = "SELECT COUNT(*) FROM Пользователи WHERE Login='"+ LoginField.getDefaultModelObjectAsString() + "' AND Password='" + PasswordField.getDefaultModelObjectAsString() + "'";
//					ResultSet rs = stmt.executeQuery(SQL);
//					while (rs.next()) {
//						if (rs.getString(1).equals("1")) {
//							feedback.setDefaultModelObject("Добро пожаловать, " + LoginField.getDefaultModelObjectAsString() + "!");
//							LoginField.setDefaultModelObject("");
//							PasswordField.setDefaultModelObject("");
//							//setResponsePage(HomePage.class);
//						}
//						else {
//							feedback.setDefaultModelObject("Введен неверный логин или пароль.");
//						}
//		            }
//					rs.close();
//		            stmt.close();
